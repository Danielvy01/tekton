...
namespace Asgardeo.OIDC.SDK
{
    ...
    public class AuthenticationHelper
    {
        ...
        private readonly ServerConfiguration config = new ServerConfiguration();
        private readonly ServerConfigurationManager configurationManager = new ServerConfigurationManager();
